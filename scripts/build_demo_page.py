...
<style>
:root{--ground:#F3F5FB;--surface:#FFFFFF;--surface-2:#E8ECF6;--ink:#0F1630;--muted:#4F5B7A;--faint:#8290B0;--line:#D3DAEA;--blue:#0E7C9F;--blue-soft:rgba(14,124,159,.12);--violet:#6A5AE0;--violet-soft:rgba(106,90,224,.12);--pink:#C9459E;--alarm:#C93A3A;--alarm-soft:rgba(201,58,58,.11);--ok:#1F8A5B;--ok-soft:rgba(31,138,91,.12);--warn:#A8720E;--warn-soft:rgba(168,114,14,.13);--grad:linear-gradient(90deg,#0E7C9F,#6A5AE0,#C9459E);--shadow:0 1px 2px rgba(6,10,30,.08),0 12px 32px -22px rgba(6,10,30,.6);--display:"Fraunces",Georgia,serif;--body:"Source Sans 3",system-ui,sans-serif;--data:"JetBrains Mono",ui-monospace,Menlo,monospace}
@media (prefers-color-scheme:dark){:root:not([data-theme="light"]){--ground:#0B1020;--surface:#131B30;--surface-2:#1B2542;--ink:#E8ECF8;--muted:#9AA6C4;--faint:#6C7794;--line:#26325A;--blue:#6EE7FF;--blue-soft:rgba(110,231,255,.14);--violet:#8B7BFF;--violet-soft:rgba(139,123,255,.16);--pink:#FF7BD5;--alarm:#FF7A7A;--alarm-soft:rgba(255,122,122,.14);--ok:#5EE0A0;--ok-soft:rgba(94,224,160,.14);--warn:#FFC15E;--warn-soft:rgba(255,193,94,.14);--grad:linear-gradient(90deg,#6EE7FF,#8B7BFF,#FF7BD5)}}
...
h1{font-family:var(--display);font-weight:600;font-size:clamp(32px,5vw,50px);line-height:1.05;letter-spacing:-.02em;margin:0 0 12px}h1::after{content:'';display:block;width:120px;height:5px;border-radius:3px;background:var(--grad);margin-top:14px}
